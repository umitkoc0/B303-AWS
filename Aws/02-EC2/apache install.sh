# Hands-on EC2-01 : How to Install Apache Web Server on EC2 Linux 3

## Outline

- Part 1 - Getting to know the Apache Web Server

- Part 2 - Launching an Amazon Linux 3 EC2 instance and Connect with SSH
...
echo "HELLO TECHPRO EDUCATION" > /var/www/html/index.html
...
<body>
    <h1>Hello to Everyone from My First Web Server B303</h1>
</body>
</html>
...
18. Configure an Amazon EC2 instance with AMI as `Amazon Linux 3`, instance type as `t2.micro`, default VPC security group which allows connections from anywhere and any port.
