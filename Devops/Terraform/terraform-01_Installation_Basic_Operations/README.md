...
- Launch an EC2 instance using the Ubuntu 24.04 AMI with a security group allowing SSH connections and a 20 GiB EBS volume..

- Connect to your instance with SSH.

```bash
ssh -i techpro.pem ubuntu@public_ip
```
...
resource "aws_instance" "tf-ec2" {
  ...
  key_name = "devops" # change me(without .pem)
  tags = {
    "Name" = "created-by-tf"
  }
}
...
- Change the "addwhateveryouwant" part of the bucket name. Because bucket name must be unique.
...
- Lets comment the EC2 instance resource block.
