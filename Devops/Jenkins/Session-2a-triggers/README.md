...
- Enter `first-job-triggered` then select `Freestyle project` and click `OK`.
...
- Check `Branch Specifier`. It must be same branch name with your `jenkinsfile-pipeline-project` Github repository. If your repository's default branch name is "main", then change "master" to "main".
