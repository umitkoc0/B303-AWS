...
- Connect to both nodes and perform the following steps in order:
...
```bash
sudo apt-get update
sudo apt-get install -y kubelet kubeadm kubectl kubernetes-cni docker.io
...
kubeadm join 172.31.77.70:6443 --token qslxog.8p1ptbi3v20wz6jg --discovery-token-ca-cert-hash sha256:668403597ed9ab35d0ccf8d1121b98d865f588d7c408083bc174fd0acdc98c50
```
